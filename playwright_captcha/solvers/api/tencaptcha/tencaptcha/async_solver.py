...
class AsyncTenCaptcha():
    ...
    async def recaptcha(self, sitekey, url, version='v2', enterprise=0, **kwargs):
        ...
        softId : int, optional
            ID of software developer. Developers who integrated their software with 10Captcha get reward: 10% of
        ...
        callback : str, optional
            ...
            the server. More info here https://10captcha.com/api-docs.php#solving_recaptchav2
        proxy : dict, optional
    ...
    async def send(self, **kwargs):
        ...
        _________
        method : str
            The name of the method must be found in the documentation https://10captcha.com/api-docs.php
        kwargs: dict
            All captcha params
        Returns
