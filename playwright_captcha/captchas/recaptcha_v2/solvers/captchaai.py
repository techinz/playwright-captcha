...
async def solve_recaptcha_v2_captcha_ai(async_captcha_ai_client: AsyncCaptchaAI, **kwargs) -> dict:
    """
    Solve Recaptcha V2 captcha using CaptchaAI service
    ...
    logger.debug('Solving Recaptcha V2 captcha using CaptchaAI...')
