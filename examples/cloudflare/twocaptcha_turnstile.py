...
ADDON_PATH = '../../playwright_captcha/utils/camoufox_add_init_script/addon'  # path to the addon script
...
async def solve_turnstile() -> None:
    ...
    async with async_playwright() as playwright:
        ...
        async with TwoCaptchaSolver(
            ...
            # search for the element that contains the turnstile challenge
